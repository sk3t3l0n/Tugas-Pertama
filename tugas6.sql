...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 28, 2025 at 11:50 AM
...
('root', '[{\"db\":\"ecommerce\",\"table\":\"products\"},{\"db\":\"commerce\",\"table\":\"products\"}]');
...
('root', '2025-07-28 09:33:06', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Create data product
INSERT INTO products (id, NamaProduk, Harga, Deskripsi, Stock)
VALUES ('1', 'Laptop Gaming', '15000000', 'Laptop Lenovo dengan spek yang dioptimalisasi untuk gaming', '7');
...
UPDATE products
SET Harga = '12500000', Stock = '10'
WHERE id = 1;

-- Menghapus data product
DELETE FROM products WHERE NamaProduk= 'Laptop Gaming';